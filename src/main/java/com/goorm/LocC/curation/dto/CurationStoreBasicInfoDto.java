...
@Getter
public class CurationStoreBasicInfoDto {
        ...
        @Builder
        public CurationStoreBasicInfoDto(Long storeId, String name, Category category, List<String> images, float rating, int reviewCount, LocalTime openTime, LocalTime closeTime, BusinessStatus businessStatus) {
        ...
        public static CurationStoreBasicInfoDto of(Store store, BusinessHour businessHour) {
            ...
            return CurationStoreBasicInfoDto.builder()
