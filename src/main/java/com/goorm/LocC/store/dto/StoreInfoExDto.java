...
public class StoreInfoExDto {
    ...
    public StoreInfoExDto(Long storeId, String name, Category category, Province province, City city, String address, String imageUrl, float rating, int reviewCount, LocalTime openTime, LocalTime closeTime, Boolean isHoliday, BusinessStatus businessStatus) {
